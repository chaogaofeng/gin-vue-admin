...
func (s *BillingPlanRouter) InitBillingPlanRouter(Router *gin.RouterGroup,PublicRouter *gin.RouterGroup) {
	...
	{
		billingPlanRouterWithoutRecord.GET("findBillingPlan", billingPlanApi.FindBillingPlan)        // 根据ID获取账单计划
		billingPlanRouterWithoutRecord.GET("getBillingPlanList", billingPlanApi.GetBillingPlanList)  // 获取账单计划列表
	}
	{
